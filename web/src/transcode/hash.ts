 ...
 */
export async function teeToHash(source: ReadableStream<Uint8Array>, write: (chunk: Uint8Array) => Promise<void>): Promise<TeeResult> {
...
export async function hashBlob(blob: Blob, write?: (chunk: Uint8Array) => Promise<void>): Promise<TeeResult> {
