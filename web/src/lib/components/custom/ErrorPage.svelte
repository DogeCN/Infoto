...
<div class="flex min-h-screen flex-col items-center justify-center bg-background p-8 text-center">
  <div class="relative mb-6">
    ...
    <span
      ...
      style="color: #ef4444; clip-path: polygon(0 0, 100% 0, 100% 45%, 0 45%); transform: translate(-2px, -1px); opacity: 0.7"
      aria-hidden="true"
    >
      {code}
    </span>
    <span
      ...
      style="color: #06b6d4; clip-path: polygon(0 55%, 100% 55%, 100% 100%, 0 100%); transform: translate(2px, 1px); opacity: 0.7"
      aria-hidden="true"
    >
      {code}
    </span>
  ...
  <a
    href="/"
    class="inline-flex items-center justify-center rounded-lg bg-primary px-6 py-2.5 text-sm font-medium text-primary-foreground transition-all duration-200 hover:bg-primary/90 active:scale-[0.98]"
  >
    返回首页
  </a>
</div>
